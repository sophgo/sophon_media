...
if [[ "$build_type" =~ "debug" ]]; then
  ...
  ./configure \
	...
	--extra-libs="-L${extra_lib_path}/lib -L${extra_bmvid_lib_path} -L${extra_bmlib_path}/lib/pcie_windows -lbmjpulite -lbmjpuapi -lbmion -lbmvpuapi -lbmvppapi -lbmvideo -lbmlib -lbmcv -lharfbuzz -lfreetype -lpng -lz -lbz2 -lgb28181_sip -lws2_32" \
