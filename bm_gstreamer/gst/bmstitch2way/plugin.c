...
GST_DEBUG_CATEGORY (gst_bmstitch2way_debug);
#define GST_CAT_DEFAULT gst_bmstitch2way_debug


static gboolean
plugin_init(GstPlugin *plugin)
{
  GST_DEBUG_CATEGORY_INIT(gst_bmstitch2way_debug, "bmstitch2way", 0, "bmstitch2way");
  ...
  /* 0 --> soc_idx */
  gst_bm_stitch2way_register(plugin, 0, sink_template1, sink_template2,src_template);
